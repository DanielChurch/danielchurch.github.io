...
open class ShaderProgram<T>(
    ...
    fun setUniform3f(location: String, vec3: Vec3) { webgl.uniform3f(getUniformLocation(location), vec3.x, vec3.y, vec3.z); }
    ...
    fun setUniformMatrix3fv(location: String, value: Float32Array) { webgl.uniformMatrix4fv(getUniformLocation(location), false, value); }
}